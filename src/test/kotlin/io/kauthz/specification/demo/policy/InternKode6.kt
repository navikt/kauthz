...
class PolicyInternKode6 {
    internal object Roles {
        const val KODE6_GRUPPE = "kode6-gruppe"
    }

    companion object {
        val `subject kan behandle person med kode6`: Policy<PolicyContext> =
            policy {
                id = "FP1"
        ...
        private val `person har kode6`: Rule<PolicyContext> =
            rule {
                id = "har_person_kode6"
        ...
        private val `person har ikke kode6`: Rule<PolicyContext> = !`person har kode6`

        private val `subject har rolle for kode6`: Rule<PolicyContext> =
            rule {
        ...
        private val `subject er intern bruker`: Rule<PolicyContext> =
            rule {
                id = "er_intern_bruker"
